      ...
      <div className="grid gap-5 row-gap-10 lg:grid-cols-2 ">
        ...
        <div className="flex flex-col justify-center items-center order-2">
          <div className="max-w-xl mb-6">
            <div>
              {/* kitchen name */}
              <h2 className="text-5xl font-Handlee text-center pb-10 text-primaryTextColor">Kitchen Name</h2>
            </div>
            {/* chef name */}
            <div className="text-center">
              <span className="text-2xl font-Handlee pr-3 font-extrabold ">Chef’s Name:</span>
              <span className="text-2xl font-Handlee font-extrabold ">Ritam Rahman</span>
            </div>
            {/* stats */}
        ...
        <div className="imageDiv max-h-96 ">
          <img
            ...
            src="https://i.imagescrap.org/2022/11/08/Biryani-By-Kilo.webp"
            alt=""
          />
        </div>
      </div>
